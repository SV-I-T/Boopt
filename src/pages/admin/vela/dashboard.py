...
def layout():
    ...
    return [
        ...
        dcc.Store(id="adm-results-vela-etapas-data"),
        html.Canvas(
            id="adm-results-vela-etapas",
        ),
        dcc.Store(id="adm-results-vela-comps-data"),
        html.Canvas(
            id="adm-results-vela-comps",
        ),
        dag.AgGrid(
...
@callback(
    ...
    Output("adm-results-vela-etapas-data", "data"),
    Output("adm-results-vela-comps-data", "data"),
...
def atualizar_dashboard_adm_vela_resultados(n: int, ids_aplicacao: list[str]):
    ids_aplicacao = ["66183110e74aab17a9999508"]
    # if not n:
    #     raise PreventUpdate
